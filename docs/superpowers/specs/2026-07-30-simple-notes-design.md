# Simple Notes product and architecture design
...
Simple Notes is a small, approachable desktop note application for computer developers. It prioritizes fast Markdown capture, clear organization, durable local storage, and links between notes. It is not intended to become an all-in-one workspace.
